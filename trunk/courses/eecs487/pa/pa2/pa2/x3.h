...
// Material node. You will need to modify its render method. 
...
// Viewpoint class stores the viewpoint parameters.
// YOUR CODE HERE: you may need to modify this class to allow
// simple navigation in the viewer. In particular, the Render() method
// need to be modified (it is called at the beginning of rendering the scene and 
// setting the lights).
...
// So a point is transformed to its parent coordinates as follows:
// P' = T * C * R * S * -C * P
// You will need to modify the Render and SetupLights methods of this class.
...
// An indexed face set (mesh) class: you will need to modify its Render() and Add()
// functions in order to fill and use its normals vector.
...
// Point light source: you will need to modify its SetupLight method.
